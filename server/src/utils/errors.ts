...
export const ErrorCodes = {
  ...
  INVALID_COMPETITION_DATES: 'INVALID_COMPETITION_DATES',
  COMPETITION_FULL: 'COMPETITION_FULL',
  COMPETITION_ALREADY_JOINED: 'COMPETITION_ALREADY_JOINED',
  COMPETITION_NOT_JOINABLE: 'COMPETITION_NOT_JOINABLE',
} as const;
